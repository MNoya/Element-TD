package  
{
	...
	public class Voting extends MovieClip
	{
		...
		{
			this.visible = true;
			this.voteResultsDialog.visible = false;
			this.voteDialog.visible = false;
            this.globals.resizeManager.AddListener(this);
			
			this.voteDialog.setup(this.gameAPI, this.globals);
			this.voteResultsDialog.setup(this.gameAPI, this.globals);
			
			this.gameAPI.SubscribeToGameEvent("etd_toggle_vote_dialog", this.ToggleVoteDialog);
		}
		
		public function ToggleVoteDialog(args:Object)
		{
			this.voteDialog.visible = args.visible;
		}
        ...
        public function onResize(re:ResizeManager):* 
		{
			...
			this.voteDialog.screenResize(re.ScreenWidth, re.ScreenHeight, correctedRatio);
			this.voteResultsDialog.screenResize(re.ScreenWidth, re.ScreenHeight, correctedRatio);
        }
