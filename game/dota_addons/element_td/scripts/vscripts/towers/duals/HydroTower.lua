...
function HydroTower:ChooseTarget(keys)
  if keys.target_points[1] then
    ...
    self.tower:SetContextThink("HydroTowerAttack", function()
...
function HydroTower:ResetTarget(keys)
  ...
  self.tower:SetContextThink("HydroTowerAttack", nil, -1);
...
function HydroTower:ShootProjectileAt(targetPos)
  ...
  self.tower:SetContextThink("Think" .. projectile.id, (function()
