...
function blacksmith_tower_fire_up:OnSpellStart()
	...
	EmitSoundOn("Hero_OgreMagi.Bloodlust.Target", self:GetCaster()) --Doesn't play, probably too loud anyway
	...
	ParticleManager:SetParticleControlEnt(particle, 2, caster, PATTACH_POINT_FOLLOW, "attach_attack1", target:GetAbsOrigin(), true)
